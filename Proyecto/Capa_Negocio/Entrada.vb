...
#Region "Metodos"
        ...
        If obj_datos_Lectura.verificarXMLP Then
            ...
            For Each producto As XmlNode In listaXML
                ...
                If Nombre = producto("Producto").InnerText Then
                    ...
                    fila("Cantidad disponible") = Cantidad + producto("Cantidaddisponible").InnerText
    ...
    Public Sub llenarTabla()
        ...
        If obj_datos_Lectura.verificarXMLPE Then
    ...
    Public Function leerXML()
        ...
        Dim dt_producto As DataTable = Me.Tablaentrada.copy
        If obj_datos_Lectura.verificarXMLPE Then
            Dim _archivoXML As XmlDocument = obj_datos_Lectura.leerXMLPE()
